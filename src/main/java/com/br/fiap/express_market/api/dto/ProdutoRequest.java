...
/**
 * Corpo aceito no POST e no PUT. Não expõe o id: na criação ele é gerado pela sequence
 * e na atualização vem pela URL, o que impede o cliente de trocar a identidade do recurso.
 */
